...
class CompletedLoansWeb extends StatefulWidget {
  const CompletedLoansWeb({super.key});

  @override
  State<CompletedLoansWeb> createState() => _CompletedLoansWebState();
}

class _CompletedLoansWebState extends State<CompletedLoansWeb> {
  @override
