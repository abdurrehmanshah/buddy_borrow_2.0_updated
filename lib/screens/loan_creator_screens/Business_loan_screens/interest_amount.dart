...
class BusinessinterestAmount extends StatefulWidget {
  const BusinessinterestAmount({Key? key}) : super(key: key);

  @override
  State<BusinessinterestAmount> createState() => _BusinessInterestAmountState();
}

class _BusinessInterestAmountState extends State<BusinessinterestAmount> {
  double _value = 4;
  @override
              ...
              child: Column(
                children: [
                  ...
                  const CustomTextButton(
                    text: 'Continue',
                    screen: BusinessMoneyTransferDate(),
                  ),
                ],
              ),
            ),
