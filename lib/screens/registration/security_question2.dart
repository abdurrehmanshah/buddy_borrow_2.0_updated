...
import 'package:newbuddyborrow/screens/registration/security_question3.dart';

import '../../core/constants/constants.dart';
import '../../core/others/notification_snackbar.dart';
import '../../mobileWidgets/custom_button.dart';

class SecurityQuestion2 extends StatelessWidget {
  const SecurityQuestion2({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          maxLines: 3,
                          minLines: 3,
                          controller: controrller.securityQuestion2,
            ...
            InkWell(
              onTap: () {
                if (controrller.securityQuestion2.text.isEmpty) {
                  kNotificationSnackbar(
                      'Error', 'Please answer this question', null);
                } else {
                  Get.to(const SecurityQuestion3());
                }
              },
