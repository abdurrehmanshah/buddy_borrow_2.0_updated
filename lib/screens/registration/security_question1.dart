...
import 'package:newbuddyborrow/screens/registration/security_question2.dart';

import '../../core/constants/constants.dart';
import '../../mobileWidgets/custom_button.dart';

class SecurityQuestion1 extends StatelessWidget {
  const SecurityQuestion1({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          maxLines: 3,
                          minLines: 3,
                          controller: controrller.securityQuestion1,
            ...
            InkWell(
              onTap: () {
                if (controrller.securityQuestion1.text.isEmpty) {
                  kNotificationSnackbar(
                      'Error', 'Please answer this question', null);
                } else {
                  Get.to(const SecurityQuestion2());
                }
              },
